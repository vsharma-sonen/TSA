...
! For turbtran only:
  ...
  !$acc enter data async create(eprs,len_scale,rhon,frh,frm,zaux,zvari,l_scal)
  !$acc enter data async create(fc_min,grad,hig,tmps,vaps,prss,liqs,diss_tar,hlp)
  !$acc enter data async create(dicke,can,ftm,shv)
  !$acc enter data async create(hor_scale,xri,lay,lays,src,dzsm,dzsh,lev,rclc)
  !$acc enter data async create(tketens_tar,lo_ice,k_2d,hk_2d,hk1_2d,h_top_2d)
  !$acc enter data async create(h_atm_2d,h_can_2d,edh,z0m_2d,z0d_2d,z2m_2d)
  !$acc enter data async create(z10m_2d,rat_m_2d,rat_h_2d,fac_h_2d,fac_m_2d,frc_2d)
  !$acc enter data async create(vel_2d,tl_s_2d,qt_s_2d,velmin,ratsea,dz_sg_m,dz_sg_h)
  !$acc enter data async create(dz_g0_m,dz_g0_h,dz_0a_m,dz_0a_h,dz_sa_h,dz_s0_h)
...
! For any application of the blocked default turbulence code:
  !$acc exit data async delete(eprs,len_scale,rhon,frh,frm,zaux,zvari,l_scal)
  !$acc exit data async delete(fc_min,grad,hig,tmps,vaps,prss,liqs,diss_tar,hlp)
  !$acc exit data async delete(dicke,can,ftm,shv)
  !$acc exit data async delete(hor_scale,xri,lay,lays,src,dzsm,dzsh,lev,rclc)
  !$acc exit data async delete(tketens_tar,lo_ice,k_2d,hk_2d,hk1_2d,h_top_2d)
  !$acc exit data async delete(h_atm_2d,h_can_2d,edh,z0m_2d,z0d_2d,z2m_2d)
  !$acc exit data async delete(z10m_2d,rat_m_2d,rat_h_2d,fac_h_2d,fac_m_2d,frc_2d)
  !$acc exit data async delete(vel_2d,tl_s_2d,qt_s_2d,velmin,ratsea,dz_sg_m,dz_sg_h)
  !$acc exit data async delete(dz_g0_m,dz_g0_h,dz_0a_m,dz_0a_h,dz_sa_h,dz_s0_h)
