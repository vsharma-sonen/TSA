...
!  Removed variables from old 2-layer soil model (cdzwxx)
!
! Code Description:
! Language: Fortran 90.
...
!   d) additional parameters for soil water content dependent freezing/melting
  ...
  DATA  cporv / 1.E-10_vpp, 1.E-10_vpp, 0.364_vpp  , 0.445_vpp  , 0.455_vpp  , 0.475_vpp  , 0.507_vpp  , 0.863_vpp  , 1.E-10_vpp, 1.E-10_vpp /
  DATA  cfcap / 1.E-10_vpp, 1.E-10_vpp, 0.196_vpp  , 0.260_vpp  , 0.340_vpp  , 0.370_vpp  , 0.463_vpp  , 0.763_vpp  , 1.E-10_vpp, 1.E-10_vpp /
  DATA  cpwp  / 0.0_vpp   , 0.0_vpp   , 0.042_vpp  , 0.100_vpp  , 0.110_vpp  , 0.185_vpp  , 0.257_vpp  , 0.265_vpp  , 0.0_vpp   ,  0.0_vpp   /
  DATA  cadp  / 0.0_vpp   , 0.0_vpp   , 0.012_vpp  , 0.030_vpp  , 0.035_vpp  , 0.060_vpp  , 0.065_vpp  , 0.098_vpp  , 0.0_vpp   ,  0.0_vpp   /
  DATA  crhoc / 1.92E6_vpp, 2.10E6_vpp, 1.28E6_vpp , 1.35E6_vpp , 1.42E6_vpp , 1.50E6_vpp , 1.63E6_vpp , 0.58E6_vpp , 4.18E6_vpp, 1.92E6_vpp /
  DATA  cik2  / 0.0_vpp   , 0.0_vpp   , 0.0035_vpp , 0.0023_vpp , 0.0010_vpp , 0.0006_vpp , 0.0001_vpp , 0.0002_vpp , 0.0_vpp   ,  0.0_vpp   /
  DATA  ckw0  / 0.0_vpp   , 0.0_vpp   , 479.E-7_vpp, 943.E-8_vpp, 531.E-8_vpp, 764.E-9_vpp, 85.E-9_vpp , 58.E-9_vpp , 0.0_vpp   ,  0.0_vpp   /
  DATA  ckw1  / 0.0_vpp   , 0.0_vpp   , -19.27_vpp , -20.86_vpp , -19.66_vpp , -18.52_vpp , -16.32_vpp , -16.48_vpp , 0.0_vpp   ,  0.0_vpp   /
  DATA  cdw0  / 0.0_vpp   , 0.0_vpp   , 184.E-7_vpp, 346.E-8_vpp, 357.E-8_vpp, 118.E-8_vpp, 442.E-9_vpp, 106.E-9_vpp, 0.0_vpp   ,  0.0_vpp   /
  DATA  cdw1  / 0.0_vpp   , 0.0_vpp   , -8.45_vpp  , -9.47_vpp  , -7.44_vpp  , -7.76_vpp  , -6.74_vpp  , -5.97_vpp  , 0.0_vpp   ,  0.0_vpp   /
  DATA  crock / 0.0_vpp   , 0.0_vpp   , 1.0_vpp    , 1.0_vpp    , 1.0_vpp    , 1.0_vpp    , 1.0_vpp    , 1.0_vpp    , 0.0_vpp   ,  0.0_vpp   /
  DATA  cala0 / 2.26_vpp  , 2.41_vpp  , 0.30_vpp   , 0.28_vpp   , 0.25_vpp   , 0.21_vpp   , 0.18_vpp   , 0.06_vpp   , 1.0_vpp   ,  2.26_vpp  /
  DATA  cala1 / 2.26_vpp  , 2.41_vpp  , 2.40_vpp   , 2.40_vpp   , 1.58_vpp   , 1.55_vpp   , 1.50_vpp   , 0.50_vpp   , 1.0_vpp   ,  2.26_vpp  /
  DATA  csalb / 0.70_vpp  , 0.30_vpp  , 0.30_vpp   , 0.25_vpp   , 0.25_vpp   , 0.25_vpp   , 0.25_vpp   , 0.20_vpp   , 0.07_vpp  ,  0.70_vpp  /
  DATA  csalbw/ 0.00_vpp  , 0.00_vpp  , 0.44_vpp   , 0.27_vpp   , 0.24_vpp   , 0.23_vpp   , 0.22_vpp   , 0.10_vpp   , 0.00_vpp  ,  0.00_vpp  /
  DATA  ck0di / 1.E-4_vpp , 1.E-4_vpp , 2.E-4_vpp  , 2.E-5_vpp  , 6.E-6_vpp  , 2.E-6_vpp  , 1.E-6_vpp  , 1.5E-6_vpp , 0.00_vpp  ,  0.00_vpp  /
  DATA  cbedi / 1.00_vpp  , 1.00_vpp  , 3.5_vpp    , 4.8_vpp    , 6.1_vpp    , 8.6_vpp    , 10.0_vpp   , 9.0_vpp    , 0.00_vpp  ,  0.00_vpp  /
  DATA  csandf/ 0.0_vpp   , 0.0_vpp   , 90.0_vpp   , 65.0_vpp   , 40.0_vpp   , 35.0_vpp   , 15.0_vpp   , 90.0_vpp   , 0.00_vpp  ,  0.00_vpp /
  DATA  cclayf/ 0.0_vpp   , 0.0_vpp   , 5.0_vpp    , 10.0_vpp    , 20.0_vpp    , 35.0_vpp    , 70.0_vpp    , 5.0_vpp    , 0.00_vpp  ,  0.00_vpp /
...
!==============================================================================
    ...
    csalb_p        = 0.15_vpp  , & !  solar albedo of ground covered by plants
    csalb_snow     = 0.90_vpp  , & !  solar albedo of ground covered by snow

#ifdef __COSMO__
    csalb_snow_min = 0.400_vpp , & ! min. solar albedo of snow for forest free surfaces
    csalb_snow_max = 0.700_vpp , & ! max. solar albedo of snow for forest free surfaces
  ! for possible later use:
    csalb_snow_fe  = 0.200_vpp , &  ! solar albedo of snow for surfaces with evergreen forest
    csalb_snow_fd  = 0.200_vpp , &  ! solar albedo of snow for surfaces with deciduous forest
#elif __ICON__
    ! T.R. 2011-09-21 csalb_snow_min/max set to values used in GME
    csalb_snow_min = 0.500_vpp , &
                           ! min. solar albedo of snow for forest free surfaces
    csalb_snow_max = 0.850_vpp , &
                           ! max. solar albedo of snow for forest free surfaces
    ! T.R. 2011-09-21 snow albedos for forests set to values used in GME
    csalb_snow_fe  = 0.270_vpp , &  ! solar albedo of snow for surfaces with evergreen forest
    csalb_snow_fd  = 0.320_vpp , &  ! solar albedo of snow for surfaces with deciduous forest
#endif

    ctalb          = 0.004_vpp , & !  thermal albedo ( of all soil types )
    cf_snow        = 0.0150_vpp, & !  parameter for the calculation of the
                                  !  fractional snow coverage
  ! for the multi-layer soil model
    cwhc       = 0.04_vpp      , & !  water holding capacity of snow ()
    chcond     = 0.01_vpp      , & !  saturation hydraulic conductivity of snow ()
    ca2        = 6.6E-07_vpp   , & !  activation energy (for snow metamorphosis) (J)
    csigma     = 75.0_vpp      , & !  snow metamorphosis, Pa

  ! cf_w changed from 0.0004 to 0.0010 (in agreement with GME)
    cf_w       = 0.0010_vpp    , & !  parameter for the calculation of the
                                  !  fractional water coverage

    csvoro     = 1.0000_vpp    , & !  parameter to estimate the subgrid-scale
                                  !  variation of orography
    cik1       = 0.0020_vpp    , & !  parameter for the determination of the
                                  !  maximum infiltaration
#ifdef __COSMO__
    cwimax_ml                 , & !  maximum interception water content
              ! this is now a namelist variable in PHYCTL
    ctau_i     = 1000.0_vpp    , & !  time constant for the drainage from the interception storage
#elif __ICON__
    ctau_i     = 7200.0_vpp    , & !  time constant for the drainage from the interception storage
#endif
    cakw       = 0.8000_vpp    , & !  parameter for averaging the water contents
                                  !  of the top and middle soil water layers to 
                                  !  calculate the hydraulic diffusivity and 
                                  !  conductiviy

    ctau1      = 1.0000_vpp    , & !  first adjustment time period in EFR-method
    ctau2      = 5.0000_vpp    , & !  second adjustment time period in EFR-method
    chc_i      = 2100.0_vpp    , & !  heat capacity of ice
    chc_w      = 4180.0_vpp    , & !  heat capacity of water

    cdzw12     = 0.1000_vpp    , & !  thickness of upper soil water layer in
                                  !  two-layer model
    cdzw22     = 0.9000_vpp    , & !  thickness of lower soil water layer in
                                  !  two-layer model
    cdzw13     = 0.0200_vpp    , & !  thickness of upper soil water layer in
                                  !  three-layer model
    cdzw23     = 0.0800_vpp    , & !  thickness of middle soil water layer in
                                  !  three-layer model
    cdzw33     = 0.9000_vpp        !  thickness of lower soil water layer in
                                  !  three-layer model

  REAL  (KIND=vpp)           ::  &
    cdsmin     = 0.0100_vpp    , & !  minimum snow depth
    crhosmin   = 500.00_vpp    , & !  minimum density of snow
    crhosmax   = 800.00_vpp    , & !  maximum density of snow
    crhosmin_ml=  50.00_vpp    , & !  minimum density of snow
    crhosmax_ml= 400.00_vpp    , & !  maximum density of snow
    crhosminf  =  50.00_vpp    , & !  minimum density of fresh snow
    crhosmaxf  = 150.00_vpp    , & !  maximum density of fresh snow
    crhogminf  = 100.00_vpp    , & !  minimum density of fresh graupel / convective snow
    crhogmaxf  = 200.00_vpp    , & !  maximum density of fresh graupel / convective snow
#ifdef __COSMO__
    crhosmint  =   0.20_vpp    , & !  minimum value of time constant for ageing of snow
#elif __ICON__
    crhosmint  =   0.125_vpp    ,& !  value of time constant for ageing
                                  !  of snow at csnow_tmin (8 days)
#endif
    crhosmaxt  =   0.40_vpp    , & !  maximum value of time constant for ageing
                                  !  of snow
    crhosmax_tmin = 200.00_vpp , & ! maximum density of snow at csnow_tmin
    csnow_tmin = 258.15_vpp    , & !  lower threshold temperature of snow for
                                  !  ageing and fresh snow density computation
                                  !  ( = 273.15-15.0)
    crhos_dw   = 300.00_vpp    , & !  change of snow density with water content
    calasmin   = 0.2000_vpp    , & !  minimum heat conductivity of snow (W/m K)
    calasmax   = 1.5000_vpp    , & !  maximum heat conductivity of snow (W/m K)
    calas_dw   = 1.3000_vpp    , & !  change of snow heat conductivity with
                                  !  water content                (W/(m**2) K)

    crhowm     =    0.8_vpp    , & !  BATS (1)
    cdmin      =    0.25E-9_vpp, & !  BATS (m**2/s)
    cfinull    =    0.2_vpp    , & !  BATS (m)
    ckrdi      =    1.0E-5_vpp , & !  BATS (m/s)
    cdash      =    0.05_vpp   , & !  BATS ((m/s)**1/2)
    clai       =    3.0_vpp    , & !  BATS
    cparcrit   =  100.0_vpp    , & !  BATS (W/m**2)
    ctend      =  313.15_vpp   , & !  BATS (K)
    csatdef    = 4000.0_vpp    , & !  BATS (Pa)

    !Minimum and maximum value of stomatal resistance (s/m)
    !used by the Pen.-Mont. method for vegetation transpiration
    !(itype_trvg=2):
    crsmin     = 150.0_vpp     , & !  BATS (s/m)
    crsmax     = 4000.0_vpp        !  BATS (s/m)
...
! --------------------------
  ...
  REAL  (KIND=vpp) ::       &
    ctalb_bm = 0.08_vpp   , & !  default effective thermal albedo of building/road environment

    ! csalb_eff_uf = 0.80_vpp,   & ! correction factor for effective albedo induced by the
    ...
    csalb_bm = 0.213_vpp  , & ! default short-wave albedo of building/road materials 
                             ! in the urban fabric
  ...
  ! c_rhoc_bm * c_ala_bm 
   ...
   !c_ai_uf = 2.0_vpp     , &
    c_uf_h  = 15.0_vpp    , & ! default height of building elements in urban fabric (metre)
    c_lnd_h = 0.01_vpp    , & ! default height of natural soil elements in natural land (metre)
    c_htw   = 1.5_vpp     , &
    c_roof  = 0.667_vpp   , &
  ...
  ! default building/road 'material' properties...
    ...
    c_rhoc_bm = 1.74E6_vpp, & ! default specific heat times density of buildings,

    !  Value of 'medium concrete' is taken (higher boundary, as average value for 
    !  concrete in,  see engineerintoolbox.com)
    c_ala_bm  = 0.87_vpp  , & ! default building material heat conductivity:
    c_isa_runoff = 1.0_vpp, & ! default fraction of water exiting from the impervious
    ...
    c_isa_delt = 0.12_vpp , & ! The maximum wet-surface fraction delta_max, see Wouters et al., 2015
    c_isa_wmax = 1.31_vpp , & ! Maximum amount of water that can be stored by impervious surfaces
...
!! as it is 'used to' the (in this context) huge epsilon of 1E-6.
    ...
    eps_temp = MAX(1.0E-6_vpp,500.0_vpp*EPSILON(1.0_vpp))
...
! --------------------------------
  ...
  REAL  (KIND=vpp)            ::  &
    max_toplaydepth  =  0.25_vpp, & ! maximum depth of uppermost snow layer for multi-layer snow scheme (25 cm)
    tune_minsnowfrac = 0.125_vpp    ! Minimum value to which the snow cover fraction is artificially reduced
...
SUBROUTINE terra_wkarr_alloc (ke_soil, ke_snow, nproma, istat)
  ...
  !$acc enter data async create(m_styp,ke_soil_hy_b)                &
...
SUBROUTINE terra_wkarr_dealloc (istat)
  ...
  !$acc exit data async delete(m_styp,ke_soil_hy_b)                 &
