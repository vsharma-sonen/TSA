...
!  This is data_parallel from COSMO version 5.07
!  But removed data_parameters and iintegers
!
!------------------------------------------------------------------------------
!
! Description:
...
! V5_5b        2018-10-29 Ulrich Blahak
!  Added variables for asynchronous output processors for writing radar data
...
! V5_6b        2019-10-16 Ulrich Blahak
!  Removed radar_master, radario_master, lradar_pe, lradario_pe, which are now part
...
! ---------------------------------------
  ...
  INTEGER ::         &
    ...
    nprocio_radar,   & ! number of extra processors for doing asynchronous radar IO
...
! ------------------------------
  ...
  INTEGER ::             &
    ...
    icomm_comp_io,       & ! communicator for the group of compute PEs + asynchronous IO PEs
